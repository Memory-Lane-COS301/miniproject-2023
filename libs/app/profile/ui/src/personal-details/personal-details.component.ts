...
export class PersonalDetailsComponent {
  ...
  get ageError(): string {
    ...
    if (this.age?.errors?.['minlength']) return 'Age should be longer than 4 characters';
    if (this.age?.errors?.['maxlength']) return 'Age should be shorter than 64 characters';
  ...
  get genderError(): string {
    ...
    if (this.gender?.errors?.['minlength']) return 'Gender should be longer than 4 characters';
    if (this.gender?.errors?.['maxlength']) return 'Gender should be shorter than 64 characters';
  ...
  get ethnicityError(): string {
    ...
    if (this.ethnicity?.errors?.['minlength']) return 'Ethnicity should be longer than 4 characters';
    if (this.ethnicity?.errors?.['maxlength']) return 'Ethnicity should be shorter than 64 characters';
