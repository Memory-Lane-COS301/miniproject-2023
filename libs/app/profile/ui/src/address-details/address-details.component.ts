...
export class AddressDetailsComponent {
  ...
  get residentialAreaError(): string {
    if (this.residentialArea?.errors?.['required']) return 'Residential area is required';
    if (this.residentialArea?.errors?.['minlength']) return 'Residential area should be longer than 6 characters';
    if (this.residentialArea?.errors?.['maxlength']) return 'Residential area should be shorter than 64 characters';
  ...
  get workAreaError(): string {
    ...
    if (this.workArea?.errors?.['minlength']) return 'Work area should be longer than 6 characters';
    if (this.workArea?.errors?.['maxlength']) return 'Work area should be shorter than 64 characters';
