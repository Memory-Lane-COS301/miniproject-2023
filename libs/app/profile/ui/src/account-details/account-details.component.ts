...
export class AccountDetailsComponent {
  ...
  get displayNameError(): string {
    ...
    if (this.displayName?.errors?.['minlength']) return 'Display name should be longer than 6 characters';
    if (this.displayName?.errors?.['maxlength']) return 'Display name should be shorter than 64 characters';
  ...
  get photoURLError(): string {
    ...
    if (this.photoURL?.errors?.['minlength']) return 'Photo URL should be longer than 6 characters';
    if (this.photoURL?.errors?.['maxlength']) return 'Photo URL should be shorter than 64 characters';
